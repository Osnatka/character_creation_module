"""Модуль start_game_banner.py отвечает за анимацию."""

from random import randint


def attack(char_name: str, char_class: str) -> str:
    """Описывает работу команды attack из функции start_training."""
...
def defence(char_name: str, char_class: str) -> str:
    """Описывает работу команды defence из функции start_training."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Описывает работу команды special из функции start_training."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Запускает функции attack, defence, special.
...
def choice_char_class():
    """Определяет char_class по выбранному имени персонажа."""
